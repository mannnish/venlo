...
class ColorConstant {
  static Color primaryBG = Color(0xff2C333B);
  static Color navBar = Color(0xff21262c);
  static Color white = Colors.white;
  static Color yellow = Color(0xffFBB03B);
  static Color purple = Color(0xff6C63FF);
  static Color grey = Color(0xffBFBFBF);
